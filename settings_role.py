...
RUN_ID = "VOTING_3_CBROLE{}_cbrole_{}".format(TIMESTAMP, LANGUAGE)
DATASET_NAME = "CBROLE3_{}".format(LANGUAGE.upper())
...
PIPE_STEPS = [
    ...
    (
        ...
        [
            ...
            # (LinearSVC(random_state=RANDOM_STATE), linearsvc_params), # PRETTY FAST
